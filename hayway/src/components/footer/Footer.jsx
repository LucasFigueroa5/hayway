...
const Footer = () => {
  return (
    <div className="footBox">
      <footer class="flex flex-col items-center  text-center text-surface dark:bg-neutral-700 dark:text-white footerContainer">
        ...
        <div class="w-full p-4 text-center copyr">
        Fundación Hayway ©2024
        </div>
      </footer>
    </div>
  );
